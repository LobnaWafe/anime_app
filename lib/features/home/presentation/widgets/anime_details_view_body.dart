            ...
            children: [
              Column(
                children: [
                  ...
                  Text(animeModel.score !=null?"${animeModel.score!}":"no data", style: Styles.textStyle16),
                ],
              ),
              //   SizedBox(width: 30,),
              Column(
              ...
              Padding(
                ...
                (
                  ...
                  children: [
                    ...
                    Text(animeModel.episodes != null?"${animeModel.episodes!}":"no data", style: Styles.textStyle14),
                  ],
                ),
                ...
                Column(
                  children: [
                    ...
                    Text((animeModel.studios != null && animeModel.studios!.isNotEmpty)?"${animeModel.studios![0].name}":"no data", style: Styles.textStyle14),
                  ],
                ),
                ],),
              ),
...
class CustomTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
         Text(animeModel.titleEnglish!, style: Styles.textStyle20,
  ...
  softWrap: true, ),
        ...
        SizedBox(height: 5),
        Text(animeModel.titleJapanese!, style: Styles.textStyle14,
        textAlign: TextAlign.center, // علشان يبقى منظم
  maxLines: 2,                 // أقصى عدد أسطر (ممكن تزودي أو تشيليها خالص)
  overflow: TextOverflow.ellipsis, // لو تخطي الأسطر يضيف "..."
  softWrap: true,),
        ...
        SizedBox(height: 10),
        Text(animeModel.rating !=null? animeModel.rating! :"no data", style: Styles.textStyle11),
      ],
    );
  }
}
